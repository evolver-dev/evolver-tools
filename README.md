...
Run this in your terminal — it auto-installs and shows amazing tools:

```bash
curl -sL https://evolver-dev.github.io/evolver-tools/try.sh | bash
```

*This one-liner installs evolver-tools (if needed) and runs an interactive demo.*

Zero external dependencies. Cross-platform (Linux / macOS / Windows). Version **38.0.14**.
