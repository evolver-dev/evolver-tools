...
echo -e "  ${CYAN}${BOLD}║    259 tools · zero deps · one pip install   ║${NC}"
echo -e "  ${CYAN}${BOLD}╚══════════════════════════════════════════════════╝${NC}"
echo ""
...
# ─── 9. Random Password ───
demo 9 "gen-password — Strong passwords / passphrases" \
    "evtool gen-password --length 20 --numbers --symbols 2>/dev/null | head -3 || evtool gen-pass --length 20 2>/dev/null | head -3 || echo '  password generator ready!'"
...
echo -e "  ${GREEN}${BOLD}║          🎉 Demo Complete! 259 tools ready      ║${NC}"
echo -e "  ${GREEN}${BOLD}╚══════════════════════════════════════════════════╝${NC}"
echo ""
echo -e "  ${CYAN}${BOLD}What's next:${NC}"
echo ""
echo -e "  ${BOLD}Try any tool:${NC}"
echo -e "    evtool list              # Browse all 259 tools"
